...
func (z *Identity) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "prikeyencrypted":
			z.PrikeyEncrypted, err = dc.ReadString()
			if err != nil {
				err = msgp.WrapError(err, "PrikeyEncrypted")
				return
			}
		case "cert":
		...
		case "wxunionid":
			z.WXUnionID, err = dc.ReadString()
			if err != nil {
				err = msgp.WrapError(err, "WXUnionID")
				return
			}
		case "type":
...
func (z *Identity) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 14
	// write "keyparam"
	err = en.Append(0x8e, 0xa8, 0x6b, 0x65, 0x79, 0x70, 0x61, 0x72, 0x61, 0x6d)
	if err != nil {
		return
	}
	...
	// write "prikeyencrypted"
	err = en.Append(0xaf, 0x70, 0x72, 0x69, 0x6b, 0x65, 0x79, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64)
	if err != nil {
		return
	}
	err = en.WriteString(z.PrikeyEncrypted)
	if err != nil {
		err = msgp.WrapError(err, "PrikeyEncrypted")
		return
	}
	...
	// write "wxunionid"
	err = en.Append(0xa9, 0x77, 0x78, 0x75, 0x6e, 0x69, 0x6f, 0x6e, 0x69, 0x64)
	if err != nil {
		return
	}
	err = en.WriteString(z.WXUnionID)
	if err != nil {
		err = msgp.WrapError(err, "WXUnionID")
		return
	}
...
func (z *Identity) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 14
	// string "keyparam"
	o = append(o, 0x8e, 0xa8, 0x6b, 0x65, 0x79, 0x70, 0x61, 0x72, 0x61, 0x6d)
	...
	// string "prikeyencrypted"
	o = append(o, 0xaf, 0x70, 0x72, 0x69, 0x6b, 0x65, 0x79, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64)
	o = msgp.AppendString(o, z.PrikeyEncrypted)
	// string "cert"
	...
	// string "wxunionid"
	o = append(o, 0xa9, 0x77, 0x78, 0x75, 0x6e, 0x69, 0x6f, 0x6e, 0x69, 0x64)
	o = msgp.AppendString(o, z.WXUnionID)
	// string "type"
...
func (z *Identity) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "prikeyencrypted":
			z.PrikeyEncrypted, bts, err = msgp.ReadStringBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "PrikeyEncrypted")
				return
			}
		...
		case "wxunionid":
			z.WXUnionID, bts, err = msgp.ReadStringBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "WXUnionID")
				return
			}
...
func (z *Identity) Msgsize() (s int) {
	s = 1 + 9 + z.KeyParam.Msgsize() + 19 + msgp.StringPrefixSize + len(z.IdentityIdentifier) + 7 + msgp.StringPrefixSize + len(z.Pubkey) + 16 + msgp.StringPrefixSize + len(z.PrikeyEncrypted) + 5 + msgp.StringPrefixSize + len(z.Cert) + 10 + msgp.StringPrefixSize + len(z.Timestamp) + 6 + msgp.StringPrefixSize + len(z.Phone) + 10 + msgp.StringPrefixSize + len(z.WXUnionID) + 5 + msgp.StringPrefixSize + len(z.Type) + 8 + msgp.StringPrefixSize + len(z.Command) + 7 + msgp.StringPrefixSize + len(z.Passwd) + 13 + msgp.StringPrefixSize + len(z.IPIdentifier) + 13 + msgp.ArrayHeaderSize
	for za0001 := range z.ModifyRecords {
